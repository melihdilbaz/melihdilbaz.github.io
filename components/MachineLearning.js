    ...
    return `
      <section id="machine-learning" class="container mx-auto px-8 py-16 bg-gradient-to-br from-gray-50 to-purple-50 rounded-3xl shadow-2xl">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 mb-8">
          ...
          <img src="components/machinelarningimage1.png" alt="Baseline Decision Tree" class="rounded-lg shadow-md">
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 mb-8">
          ...
          <img src="components/machinelarningimage2.png" alt="Optimized Decision Tree" class="rounded-lg shadow-md">
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 mb-8">
          ...
          <img src="components/machinelarningimage3.png" alt="Feature Importance Graph" class="rounded-lg shadow-md">
        </div>
